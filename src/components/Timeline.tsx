...
export default function Timeline() {
  ...
  return (
    <section id="journey" ref={container} className="relative flex flex-col items-start px-6 py-20 md:px-12 md:py-28 lg:px-16 lg:py-32 bg-bg-secondary overflow-hidden">
