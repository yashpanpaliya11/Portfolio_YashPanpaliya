  ...
  return (
    <section id="experience" ref={container} className="relative border-b border-[#ffffff14] flex flex-col p-8 md:p-12 lg:p-16 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="w-full relative z-10 max-w-5xl mx-auto">
        ...
        <div 
          ref={cardRef} 
          className="relative flex flex-col md:flex-row gap-6 md:gap-8 bg-[#0a0a0a] border border-[#ffffff14] p-6 md:p-8 rounded-lg overflow-hidden group hover:border-[#ffffff2a] transition-colors"
        >
          {/* Subtle green left accent */}
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#00ff88]"></div>
          ...
          <div className="shrink-0 w-full sm:w-48 md:w-56 mt-6 md:mt-0 rounded-lg overflow-hidden border border-[#ffffff14] bg-[#030712] group-hover:border-[#ffffff2a] transition-colors relative self-start">
